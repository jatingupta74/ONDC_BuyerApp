        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">ONDC Buyer</span>
            </div>
            <p className="text-gray-300 text-sm">
              Your gateway to the Open Network for Digital Commerce. Discover products from verified sellers across India.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=grocery" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Grocery
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">support@ondcbuyer.com</span>
              </div>
              <div className="flex items-start space-x-3">
                <MapPin className="w-4 h-4 text-gray-400 mt-0.5" />
                <span className="text-gray-300 text-sm">
                  123 Digital Commerce Street<br />
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 ONDC Buyer App. All rights reserved.
            </p>
